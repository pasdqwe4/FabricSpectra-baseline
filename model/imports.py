...
def is_installed(module_name: str):  # name of the module that is being checked
...
def beep(inp=1, duration=0.1, n=1):
    try:
        import IPython
    except ImportError:
        raise ImportError("You need to install IPython to use beep")
